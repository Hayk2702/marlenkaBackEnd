$(document).ready(function () {
    ...
    $(".open_miniSide").click(function () {
        ...
        $(".boundary_line").toggleClass("mini_boundary_line");
    ...
    if ($('#webticker-dark-icons').length) {
        $("#webticker-dark-icons").webTicker({height: 'auto', duplicate: true, startEmpty: false, rssfrequency: 5});
    }
    if ($('#webticker-dark1').length) {
        $("#webticker-dark1").webTicker({height: 'auto', duplicate: true, startEmpty: false, rssfrequency: 5});
    }
    ...
    if ($('#webticker-dark3').length) {
        $("#webticker-dark3").webTicker({height: 'auto', startEmpty: false, rssfrequency: 5});
    }
    ...
    if ($('#webticker-white-icons').length) {
        $("#webticker-white-icons").webTicker({height: 'auto', duplicate: true, startEmpty: false, rssfrequency: 5,});
    }
    if ($('#webticker-white2').length) {
        $("#webticker-white2").webTicker({height: 'auto', duplicate: true, startEmpty: false, rssfrequency: 5,});
    }
