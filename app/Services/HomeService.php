...
class HomeService
{
    ...
    public function getProducts($request)
    {
        ...
        return Response::json(["data"=>$products,"isSuccess"=>true]);
    }
    ...
    public function getCategories($request)
    {
        ...
        return Response::json(["data"=>$categories,"isSuccess"=>true]);
    }

    public function getFlavors($request)
    {

        $flavors = Flavor::get();
        return Response::json(["data"=>$flavors,"isSuccess"=>true]);
    }
}
